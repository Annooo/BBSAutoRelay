...
-- ----------------------------
INSERT INTO `tb_account` VALUES ('1', '18444005278', 'aaa18444005278', '{\"capsion_ticket\":\"2|1:0|10:1533546040|14:capsion_ticket|44:NmM3NGUxYjc5NmIwNDUxOTg3NjU4Nzc0YTA4YTAyMzY=|1b7dd0a5af82c0da01aada581d84c3c08143e6fbf8d4732e3cdf8d7f4ac95c35\",\"l_n_c\":\"1\",\"l_cap_id\":\"ZGYxZDg3Y2YxMjkyNDMyYWE0ZjY2OGJkZGY2ZGZkZjk=|1533546040|eb69ae6243dbf317abe5a7a8b369307f6b10cafe\",\"cap_id\":\"MGE1MmRkNjcyYzdhNDg5NGE0ZmRjMjRmZmE3MzI5N2I=|1533546040|1e5638c3eeba2c91c531af622f6a4f394e8c09f0\",\"n_c\":\"1\",\"r_cap_id\":\"MWQ3YzRmMDk0NGIyNDQwYjlkZjgxYTA2YjNiZDY3YWU=|1533546040|2a6f3d2eab2118e9dad841635fae5b5c8db15544\",\"q_c1\":\"d17fd03d98e34a2689ac1158d3b0d9a9|1533546040000|1533546040000\",\"tgw_l7_route\":\"27a99ac9a31c20b25b182fd9e44378b8\",\"z_c0\":\"2|1:0|10:1533546043|4:z_c0|80:MS4xTFBaWEN3QUFBQUFtQUFBQVlBSlZUVHRjVlZ6UF9kLTNUUU43VnJCb05lQUQ3QjhXUEVLS1hRPT0=|114480f323987620de4e9fbbf4faeb2cacc4a35ea468866c17f04d62f1169418\",\"_xsrf\":\"qeWihiXYovFzTL68umMDIzM3QyXvWpI4\"}', '2018-08-06 17:00:43', null, '2018-07-30 15:16:03');
...
CREATE TABLE `tb_admin` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `tb_admin_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `tb_role` (`role_id`) ON DELETE SET NULL ON UPDATE SET NULL
...
-- Records of tb_menu
-- ----------------------------
INSERT INTO `tb_menu` VALUES ('1', '后台首页', '', 'page/main.html', '', 'false', '0', '9999');
INSERT INTO `tb_menu` VALUES ('2', '管理员管理', '', '', '', 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('3', '角色管理', '&#xe613;', 'sys/roleList', null, 'false', '2', null);
INSERT INTO `tb_menu` VALUES ('4', '管理员列表', '&#xe613;', 'sys/adminList', null, 'false', '2', null);
INSERT INTO `tb_menu` VALUES ('9', '用户管理', '&#xe61d;', null, null, 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('10', '添加用户', '&#xe608;', 'user/addUser', null, 'false', '9', null);
INSERT INTO `tb_menu` VALUES ('11', '管理用户', '&#xe60e;', 'user/userList', null, 'false', '9', null);
INSERT INTO `tb_menu` VALUES ('14', '系统日志', '&#xe61d;', null, null, 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('15', '日志管理', '&#xe642;', 'log/logList', null, 'false', '14', null);
INSERT INTO `tb_menu` VALUES ('16', '查看', '', '', 'sys:role:list', 'false', '3', null);
INSERT INTO `tb_menu` VALUES ('17', '新增', null, null, 'sys:role:save', 'false', '3', null);
INSERT INTO `tb_menu` VALUES ('18', '修改', null, null, 'sys:role:update', 'false', '3', null);
INSERT INTO `tb_menu` VALUES ('19', '删除', null, null, 'sys:role:delete', 'false', '3', null);
INSERT INTO `tb_menu` VALUES ('20', '查看', null, null, 'sys:admin:list', 'false', '4', null);
INSERT INTO `tb_menu` VALUES ('21', '新增', null, null, 'sys:admin:save', 'false', '4', null);
INSERT INTO `tb_menu` VALUES ('22', '修改', null, null, 'sys:admin:update', 'false', '4', null);
INSERT INTO `tb_menu` VALUES ('23', '删除', null, null, 'sys:admin:delete', 'false', '4', null);
INSERT INTO `tb_menu` VALUES ('33', '新增', null, null, 'user:user:save', 'false', '10', null);
INSERT INTO `tb_menu` VALUES ('34', '查看', null, null, 'user:user:list', 'false', '11', null);
INSERT INTO `tb_menu` VALUES ('35', '新增', null, null, 'user:user:save', 'false', '11', null);
INSERT INTO `tb_menu` VALUES ('36', '修改', null, null, 'user:user:update', 'false', '11', null);
INSERT INTO `tb_menu` VALUES ('37', '删除', null, null, 'user:user:delete', 'false', '11', null);
INSERT INTO `tb_menu` VALUES ('42', '查看', '', '', 'log:log:list', 'false', '15', null);
INSERT INTO `tb_menu` VALUES ('43', 'SQL监控', '&#xe642;', null, null, 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('44', 'SQL监控', '&#xe642;', 'sys/druid', null, 'false', '43', null);
INSERT INTO `tb_menu` VALUES ('45', '查看', null, null, 'sys:druid:list', 'false', '44', null);
INSERT INTO `tb_menu` VALUES ('46', '菜单管理', '&#xe642;', 'sys/menuList', null, 'false', '2', null);
INSERT INTO `tb_menu` VALUES ('47', '查看', null, null, 'sys:menu:list', 'false', '46', null);
INSERT INTO `tb_menu` VALUES ('48', '新增', null, null, 'sys:menu:save', 'false', '46', null);
INSERT INTO `tb_menu` VALUES ('49', '修改', null, null, 'sys:menu:update', 'false', '46', null);
INSERT INTO `tb_menu` VALUES ('50', '删除', null, null, 'sys:menu:delete', 'false', '46', null);
INSERT INTO `tb_menu` VALUES ('51', 'test', '', '', '', 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('52', 'test1', '', '', '', 'false', '51', null);
INSERT INTO `tb_menu` VALUES ('53', '查看', '', '', '', 'false', '52', null);
INSERT INTO `tb_menu` VALUES ('63', 'rr', '', '', '', 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('64', 'rr1', '', '', '', 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('65', 'rerw', '', '', '', 'false', '63', null);
INSERT INTO `tb_menu` VALUES ('67', 'sdfsf', '', '', '', 'false', '64', null);
INSERT INTO `tb_menu` VALUES ('92', 'r3', '', '', '', 'false', '0', null);
INSERT INTO `tb_menu` VALUES ('93', 'wqeq', '', '', '', 'false', '0', '231');
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES ('1', '超级管理员', '超级管理员');
...
CREATE TABLE `tb_role_menu` (
  ...
  KEY `role_id` (`role_id`),
  CONSTRAINT `tb_role_menu_ibfk_1` FOREIGN KEY (`menu_id`) REFERENCES `tb_menu` (`menu_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tb_role_menu_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `tb_role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tb_role_menu` VALUES ('9', '1');
INSERT INTO `tb_role_menu` VALUES ('10', '1');
INSERT INTO `tb_role_menu` VALUES ('11', '1');
INSERT INTO `tb_role_menu` VALUES ('14', '1');
INSERT INTO `tb_role_menu` VALUES ('15', '1');
INSERT INTO `tb_role_menu` VALUES ('16', '1');
INSERT INTO `tb_role_menu` VALUES ('17', '1');
INSERT INTO `tb_role_menu` VALUES ('18', '1');
INSERT INTO `tb_role_menu` VALUES ('19', '1');
INSERT INTO `tb_role_menu` VALUES ('20', '1');
INSERT INTO `tb_role_menu` VALUES ('21', '1');
INSERT INTO `tb_role_menu` VALUES ('22', '1');
INSERT INTO `tb_role_menu` VALUES ('23', '1');
INSERT INTO `tb_role_menu` VALUES ('33', '1');
INSERT INTO `tb_role_menu` VALUES ('34', '1');
INSERT INTO `tb_role_menu` VALUES ('35', '1');
INSERT INTO `tb_role_menu` VALUES ('36', '1');
INSERT INTO `tb_role_menu` VALUES ('37', '1');
INSERT INTO `tb_role_menu` VALUES ('42', '1');
INSERT INTO `tb_role_menu` VALUES ('43', '1');
INSERT INTO `tb_role_menu` VALUES ('44', '1');
INSERT INTO `tb_role_menu` VALUES ('45', '1');
INSERT INTO `tb_role_menu` VALUES ('46', '1');
INSERT INTO `tb_role_menu` VALUES ('47', '1');
INSERT INTO `tb_role_menu` VALUES ('48', '1');
INSERT INTO `tb_role_menu` VALUES ('49', '1');
INSERT INTO `tb_role_menu` VALUES ('50', '1');
INSERT INTO `tb_role_menu` VALUES ('51', '1');
INSERT INTO `tb_role_menu` VALUES ('52', '1');
INSERT INTO `tb_role_menu` VALUES ('53', '1');
INSERT INTO `tb_role_menu` VALUES ('63', '1');
INSERT INTO `tb_role_menu` VALUES ('64', '1');
INSERT INTO `tb_role_menu` VALUES ('65', '1');
INSERT INTO `tb_role_menu` VALUES ('67', '1');
INSERT INTO `tb_role_menu` VALUES ('92', '1');
INSERT INTO `tb_role_menu` VALUES ('93', '1');
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES ('27', 'isduxd@qq.com', 'test', '96e79218965eb72c92a549dd5a330112', '0', '2018-03-25', '北京通州科创十四街区', '17693109923', 'b3f28566dac54f86bd4f4c2ce36e23d8019', '1', '2018-03-25 14:48:48');
INSERT INTO `tb_user` VALUES ('28', '123@qq.com', '2113', '96e79218965eb72c92a549dd5a330112', '1', '2018-07-26', '123123', '17693109997', 'c6411671821c43ca926c032e51ded16a897', '1', '2018-07-27 09:59:16');
INSERT INTO `tb_user` VALUES ('29', 'sdf@163.com', '123123', '96e79218965eb72c92a549dd5a330112', '2', '2018-07-27', '123123', '17111111111', '92197e8f8a5647ae8be96fe2db555575147', '1', '2018-07-27 14:23:55');
